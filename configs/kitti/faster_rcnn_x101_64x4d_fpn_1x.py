...
workflow = [('train', 1)]
dist_params = dict(backend='nccl', port=19899)
log_level = 'INFO'

import datetime
config_file_name = './output/faster_rcnn_x101_64x4d_fpn_1x/'
alias = '_'.join(['2D_FPN', 'lr', str(optimizer['lr']), 'nms', str(test_cfg['rcnn']['nms']['iou_thr']), 'epoch', str(total_epochs)])
