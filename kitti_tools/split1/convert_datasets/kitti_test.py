...
kitti_raw['calib'] = os.path.join(kitti_raw['base'], 'testing', 'calib')
kitti_raw['img'] = os.path.join(kitti_raw['base'], 'testing', 'image_2')

test_file = 'kitti_tools/split1/test.txt'
test_list = []
...
mmcv.dump(test_list, os.path.join(os.getcwd(), os.path.join(os.getcwd(), 'kitti_tools', 'split1', 'test.pkl')))
